...
public:
	...
	static Vector3f getPositionAt(std::vector<Vector3f> state, int i) { return state.at(i*2); };
	static Vector3f getVelocityAt(std::vector<Vector3f> state, int i) { return state.at(i*2 + 1); };
